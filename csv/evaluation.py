"""
This script is for evaluating deduping performance given set of known duplicates.
"""
...
manual_clusters = 'input_with_true_ids.csv' # file containing known duplicates
dedupe_clusters = 'output.csv'
